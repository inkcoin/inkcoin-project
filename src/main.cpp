...
// Copyright (c) 2014 The Inkcoin developers
...
uint256 hashGenesisBlock("0x000003dd806aea9af78f8d80bd4e89af70a1c7db1a455558a085a7885cba59de");
static const unsigned int timeGenesisBlock = 1393058516;
...
const string strMessageMagic = "Inkcoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Saturday 22, February 2014 CET";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xeeb1fb8dff18fabb89afab05dbb05204208b55762d8077ed4e8cdcfc7cfd772e"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("InkcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("InkcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("InkcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("inkcoin-miner");
    ...
    try { loop {
        ...
        printf("Running InkcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("InkcoinMiner terminated\n");
        throw;
    }
}
