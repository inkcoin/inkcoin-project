...
const QString BITCOIN_IPC_PREFIX("inkcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click inkcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start inkcoin: click-to-pay handler");
    else
...
{
    // clicking on inkcoin: URLs creates FileOpen events on the Mac:
